  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="@if(app()->getLocale() == 'ar') {{ url('locale/en') }} @else {{ url('locale/ar') }} @endif" class="nav-link">
          @if(app()->getLocale() == 'ar')
           EN
          @else
            AR
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="{{ route('dashboard.profile') }}" class="nav-link @if($title == 'profile') active @endif">
              <i class="nav-icon fas fa-th"></i>
              <p>
                {{ __('words.Profile') }}
              </p>
          ...
          <li class="nav-item">
            <a href="{{ route('dashboard.users') }}" class="nav-link @if($title == 'users' || $title == 'edit user' || $title == 'create user') active @endif">
              <i class="nav-icon fas fa-th"></i>
              <p>
                {{ __('words.Users') }}
              </p>
